...
- Made a device that can measure people’s eyes’ parameters from only one picture. All the calculations are done in a raspberry pi processor. By training a YOLOV11 object detection and segmentation model, the device can detect glasses and key points on people’s face. Use a Detph Camera(Orbbec 215) to get coordinates of keypoints in real-world to calculate the measruements such as pupil distance, pupil height, etc. 
- The YOLO model is trained using Ultralytics online, and export to onnxruntime format to accelerate running at raspberry pi.  
![](./stopto1.png)  
![](./stopto2.png)  
...
- <img  alt="image" src="https://github.com/user-attachments/assets/a9281ecd-f994-4096-becd-ce64faa44ebd" />  
- <img  alt="image" src="https://github.com/user-attachments/assets/b284f009-9d6b-4488-ae57-589e53f654b1" />
...
- <img width="60%" alt="image" src="https://github.com/user-attachments/assets/7c54d557-c3d6-49b0-b1a7-82da4feb6d53" />
- <img width="60%" alt="image" src="https://github.com/user-attachments/assets/e88b3282-fb1a-4a1c-9930-7cd7aa427d1e" />
